...
Package.on_use(function (api) {
  ...
  api.add_files([
    ...
    'client/views/admin/blocks/block_zone_editor.js',
    'client/views/admin/blocks/modals/delete_block.js',
    'client/views/admin/blocks/modals/edit_block.js',
    'client/views/admin/blocks/modals/existing_block.js',
    'client/views/admin/blocks/modals/tag_block.js',

...
(function (root, factory) {
  ...
  $.extend(Selectize.prototype, {
    setup: function () {
      ...
      $wrapper.css({ width: self.$input[0].style.width });
    ...
    destroy: function () {
      ...
      self.$input.html('').append(revertSettings.$children).removeAttr('tabindex').attr({ tabindex: revertSettings.tabindex }).show();
      $(window).off(eventNS);
